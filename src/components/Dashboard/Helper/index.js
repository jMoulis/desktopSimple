          ...
          >
            ...
            <div className="helper-content">
              ...
              <ul>
                <li>
                  <div>
                    Create your own team as a project manager and select your
                    teammates -
                    <button
                      name="create-team"
                      type="button"
                ...
                <li>
                  <div>
                    Subscribe to a project and then wait until a project manager
                    selects you -
                    <button
              ...
              <h2>What's next?</h2>
              <p>
                As soon as you have a team, an icon will magically appear on
                your desktop
              </p>
              <p>Icon</p>
